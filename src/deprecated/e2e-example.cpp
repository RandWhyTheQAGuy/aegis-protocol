/** OUTDATED FILE - SEE main_aegis_protocol.cpp FOR CURRENT EXAMPLE
...
// Includes
// =============================================================================
#include "uml001/core/bft_clock_client.h"        // BftClockClient, BftClockClientConfig,
                                     // BftClockDaemonHandle, BftClockIpcError
#include "uml001/core/clock.h"       // IClock, init_clock, get_clock, NOW,
...
#include "uml001/core/handshake.h"   // HandshakeValidator, NonceCache, SessionContext
#include "uml001/security/multi_party_issuance.h"    // MultiPartyIssuer
#include "uml001/security/transparency_log.h"        // TransparencyLog
                                          ...
                                          const BftClockClient& clock_client)
{
    ...
    vault.append(event_type, session_id, actor_id, payload_hash, metadata, t);  // 6-arg API
}
