...
Recommended deployment order for maximum early value:
  ...
  1. Semantic Passport + Registry          (establishes identity layer)
  2. Session State Machine + Entropy Flush (addresses most urgent gap)
  3. Semantic Classifiers + Policy Engine  (automates semantic enforcement)
  4. Cold Audit Vault                      (enables forensics and compliance)
  5. BFT Scalar Consensus                  (hardens multi-agent clusters)
  6. Capability Handshake                  (formalizes session setup)
